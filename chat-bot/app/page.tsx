...
import { MessageSquare, Clock, CheckCircle, XCircle, AlertCircle, Plus, History, Sparkles } from "lucide-react"
import { localStorageService, type ConversationSummary } from "@/lib/services/local-storage-service"
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="max-w-2xl text-center space-y-6">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Our AI-powered platform automates the initial screening process for ICU Registered Nurses, saving you time
            and ensuring consistent candidate evaluation.
          </p>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        variant={conv.completed ? "default" : conv.endedEarly ? "destructive" : "secondary"}
                        className="text-xs"
                      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-gray-600">
                  Our AI conducts initial interviews, asking structured questions about experience, salary, and
                  licensing.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600">
                  The system identifies key information and flags candidates based on predefined criteria.
                </p>
              </div>
              <div>
                <h4 className="font-medium text-gray-900 mb-1">Seamless History</h4>
                <p className="text-gray-600">
                  All conversations are saved, allowing you to review past interviews and candidate responses anytime.
                </p>
              </div>
              <div>
                <h4 className="font-medium text-gray-900 mb-1">Focus on Top Talent</h4>
                <p className="text-gray-600">
                  Spend less time on initial screenings and more time engaging with qualified candidates.
                </p>
              </div>
            </div>
          </CardContent>
