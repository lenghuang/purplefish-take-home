      ...
      <div className="sticky top-0 z-10 bg-white border-b px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          {conversations.length > 0 && (
            <Button variant="ghost" size="sm" onClick={clearHistory} className="text-xs text-red-600">
              Clear All
            </Button>
          )}
        </div>
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-start gap-3">
                    {getStatusIcon(conv)}
                    <div>
                      <h3 className="font-medium text-gray-900">{conv.candidateName || "Anonymous Candidate"}</h3>
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-red-600">
                    {conversations.filter((c) => c.endedEarly).length}
                  </div>
