    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <Badge className="mb-4 bg-blue-100 text-blue-800 hover:bg-blue-100">🚀 AI-Powered HR Screening Tool</Badge>
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Connect job seekers with opportunities through intelligent AI conversations. Screen candidates efficiently
            or get matched with your dream job - all powered by advanced AI.
          </p>
        </div>
          ...
          <Card className="relative overflow-hidden border-2 hover:border-blue-300 transition-all duration-300 hover:shadow-xl group">
            ...
            <CardHeader className="pb-4">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <CardTitle className="text-2xl text-gray-900">For Job Seekers</CardTitle>
                  <CardDescription className="text-lg">Get screened for multiple opportunities</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Smart Screening Conversations</h4>
                    <p className="text-gray-600 text-sm">Engage with AI recruiters tailored to specific job roles</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Practice interviews and get screened anytime, anywhere</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <TrendingUpIcon className="h-5 w-5 text-green-500 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Multiple Role Screening</h4>
                    <p className="text-gray-600 text-sm">Get evaluated for various positions simultaneously</p>
                  </div>
                </div>
              </div>
              <Button
            ...
            <CardHeader className="pb-4">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <CardDescription className="text-lg">Automate screening for thousands of candidates</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Automated Screening</h4>
                    <p className="text-gray-600 text-sm">AI conducts initial interviews and evaluations</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <TrendingUpIcon className="h-5 w-5 text-green-500 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Scale Your Hiring</h4>
                    <p className="text-gray-600 text-sm">Screen hundreds of candidates simultaneously</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <StarIcon className="h-5 w-5 text-green-500 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Quality Insights</h4>
                    <p className="text-gray-600 text-sm">Get detailed candidate evaluations and summaries</p>
                  </div>
                </div>
              </div>
              <Button
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border mb-16">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Why Choose Our AI HR Screening Tool?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">AI that understands context and asks relevant questions</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Reduce screening time by up to 85% with automation</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">AI analyzes compatibility beyond just keywords</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Comprehensive candidate evaluations and reports</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="p-6">
              ...
              <p className="text-gray-600 mb-4 italic">
                "This AI screening tool transformed our hiring process. We're now able to evaluate 10x more candidates
            ...
            <Card className="p-6">
              ...
              <p className="text-gray-600 mb-4 italic">
                "As a job seeker, this platform helped me practice interviews and get screened for multiple roles. I
                landed my dream job within weeks!"
              </p>
              <div className="text-sm">
        ...
        <div className="text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of companies and job seekers using AI-powered screening
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button onClick={() => onSelectRole("hunter")} size="lg" variant="secondary" className="text-lg px-8">
