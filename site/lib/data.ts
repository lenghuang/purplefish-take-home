...
export function getConversations(): Conversation[] {
  return getStoredConversations().sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime())
}
...
export function updateConversation(id: string, messages: Message[], isDone: boolean): void {
  const conversations = getStoredConversations()
